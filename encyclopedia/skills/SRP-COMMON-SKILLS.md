...
每个技能有三重约束：tiers（哪些 Tier 可学）、minStage（最低形态阶段：1 基础/2 中间/3 最终/4 巢穴 IV）、denied（明确排除者）。stage 由 relationships.json 中已被证明的成长链推导。 另外，B. 适应系的全部技能受 speciesGate 约束：只有源码中 supportsDamageAdaptation() 返回 true 的生物可学——这是 Species Restriction 的机器化实现。 被感染的宿主层级（ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL）共享 INBORN 与 CRUDE 的基础工具集，因为它们本身就是寄生宿主。 传送系技能以 ASSIMILATED 的同化末影人为原型。 DETERRENT 层的五个成员（dispatcherten / kyphosis / seizer / sentry / worm）movementSpeed 全部为 0.0，因此它们共享基础感染与场地工具集。
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, PREEMINENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 虫 / 物理
- **威力 / 命中 / PP**: 40 / 100 / 25
...
- **矩阵修正记录**: 矩阵修正：加入 ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL。这五个 tier 都是被感染的宿主，本来就具备寄生体的基础工具（感染、接触、撕裂），不可能比 INBORN 更少。 矩阵修正：加入 DETERRENT。阻遏体（DeterrentParasiteEntity）的 movementSpeed 全部为 0.0，它们无法移动、无法追击，其全部作用依赖感染扩散与场地污染——这些正是基础工具集的内容。 矩阵修正：加入 PREEMINENT。该层生物（PreeminentParasiteEntity）的 health 为 310~420、damage 为 33~110，是最强的寄生体层级，不可能缺少基础工具集。 矩阵修正：加入 ANCIENT。远古层（AncientParasiteEntity）是灾害级生物，拥有 ServerBossEvent 与 AncientPart[] 部位系统，不可能缺少基础工具集。 矩阵修正：加入 DERIVED。衍化体（Draconite 525/30/210、Kirin 410/30/155）是全图鉴数值最高的两只，不可能缺少基础工具集。 矩阵修正：加入 ABOMINATION。畸变体（AbominationEntity）是近战畸变个体，源码类注释为 Legacy Many Bodies and Giant Head close-combat abominations，不可能缺少基础工具集。

### 感染撕咬 / Infecting Bite

- **ID**: `infectingbite`
- **来源机制**: Call Of The Hive + 寄生体近战撕咬
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, PREEMINENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 虫 / 物理
- **威力 / 命中 / PP**: 65 / 95 / 20
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, NEXUS, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 虫 / 变化
- **威力 / 命中 / PP**: - / 100 / 10
...
- **适用 Tier**: WALKING_HEAD, ASSIMILATED, PRIMITIVE, ADAPTED, PURE, PREEMINENT, NEXUS, ANCIENT, DERIVED
- **属性 / 类别**: 毒 / 特殊
- **威力 / 命中 / PP**: 70 / 100 / 15
...
- **矩阵修正记录**: 矩阵修正：加入 ASSIMILATED。同化末影龙（sim_dragone）本身就是范围感染源（260 血量 + 龙息铺感染），排除它不合理。 矩阵修正：加入 WALKING_HEAD。同化末影龙头（sim_dragonehead）保留完整龙息且生命 78.0，本身就是范围感染源。 矩阵修正：加入 DERIVED。衍化体（Draconite / Kirin）的 health 为 410~525、damage 为 155~210，是全图鉴最强两只，其存在本身就是范围感染源并自带领域。

### 寄生孢子 / Parasitic Spores

- **ID**: `parasiticspores`
- **来源机制**: Call Of The Hive 的持续传播
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, NEXUS, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 草 / 变化
- **威力 / 命中 / PP**: - / 90 / 15
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, NEXUS, PREEMINENT, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, DERIVED, ABOMINATION
- **属性 / 类别**: 虫 / 变化
- **威力 / 命中 / PP**: - / 100 / 20
...
- **适用 Tier**: CRUDE, INBORN, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, DERIVED, ABOMINATION
- **属性 / 类别**: 超能 / 变化
- **威力 / 命中 / PP**: - / 必中 / 20
...
- **适用 Tier**: CRUDE, INBORN, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 超能 / 变化
- **威力 / 命中 / PP**: - / 必中 / 15
...
- **适用 Tier**: CRUDE, INBORN, ADAPTED, PREEMINENT, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, DERIVED, ABOMINATION
- **属性 / 类别**: 超能 / 变化
- **威力 / 命中 / PP**: - / 必中 / 10
...
- **ID**: `resistancelog`
- **来源机制**: Adaptation system
- **适用 Tier**: CRUDE, INBORN, ADAPTED, PURE, PREEMINENT, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, DERIVED, ABOMINATION
- **属性 / 类别**: 钢 / 变化
- **威力 / 命中 / PP**: - / 必中 / 10
...
- **适用 Tier**: CRUDE, INBORN, ADAPTED, PREEMINENT, ANCIENT, DERIVED, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ABOMINATION
- **属性 / 类别**: 超能 / 变化
- **威力 / 命中 / PP**: - / 必中 / 5
...
- **矩阵修正记录**: 矩阵修正：加入 ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL。这五个 tier 都是被感染的宿主，本来就具备寄生体的基础工具（感染、接触、撕裂），不可能比 INBORN 更少。 矩阵修正：加入 DETERRENT。阻遏体（DeterrentParasiteEntity）的 movementSpeed 全部为 0.0，它们无法移动、无法追击，其全部作用依赖感染扩散与场地污染——这些正是基础工具集的内容。 矩阵修正：加入 ABOMINATION。畸变体（AbominationEntity）是近战畸变个体，源码类注释为 Legacy Many Bodies and Giant Head close-combat abominations，不可能缺少基础工具集。
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, DERIVED, ABOMINATION
- **属性 / 类别**: 一般 / 物理
- **威力 / 命中 / PP**: 55 / 100 / 25
...
- **适用 Tier**: INBORN, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, DERIVED, ABOMINATION（需第 2 阶段）
- **属性 / 类别**: 恶 / 物理
- **威力 / 命中 / PP**: 80 / 90 / 15
...
- **视觉表现**: 三道深可见骨的爪痕。
- **不能学习者**: INBORN 只能学裂创。
- **矩阵修正记录**: 深度撕裂比裂创更深，只有体型增大的第二形态以上才能造成。 矩阵修正：加入 ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL。这五个 tier 都是被感染的宿主，本来就具备寄生体的基础工具（感染、接触、撕裂），不可能比 INBORN 更少。 矩阵修正：加入 DETERRENT。阻遏体（DeterrentParasiteEntity）的 movementSpeed 全部为 0.0，它们无法移动、无法追击，其全部作用依赖感染扩散与场地污染——这些正是基础工具集的内容。 矩阵修正：加入 DERIVED。衍化体（Draconite 525/30/210、Kirin 410/30/155）是全图鉴数值最高的两只，不可能缺少基础工具集。 矩阵修正：加入 ABOMINATION。畸变体（AbominationEntity）是近战畸变个体，源码类注释为 Legacy Many Bodies and Giant Head close-combat abominations，不可能缺少基础工具集。

### 血流加速 / Blood Rush

- **ID**: `bloodrush`
- **来源机制**: bleed 与移动创伤的组合
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, FERAL, PURE, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, PREEMINENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 100 / 15
...
- **ID**: `rendingpursuit`
- **来源机制**: SRP 追猎行为 + bleed
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, FERAL, PURE, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, PREEMINENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 恶 / 物理
- **威力 / 命中 / PP**: 50 / 100 / 20
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 毒 / 物理
- **威力 / 命中 / PP**: 60 / 95 / 20
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, NEXUS, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, PREEMINENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 毒 / 变化
- **威力 / 命中 / PP**: - / 100 / 15
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ANCIENT, DERIVED, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ABOMINATION
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 100 / 20
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, DETERRENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, PREEMINENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 虫 / 物理
- **威力 / 命中 / PP**: 35 / 100 / 30
- **效果**: 命中后附加 1 层【针刺】。
...
- **矩阵修正记录**: 矩阵修正：加入 ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL。这五个 tier 都是被感染的宿主，本来就具备寄生体的基础工具（感染、接触、撕裂），不可能比 INBORN 更少。 矩阵修正：加入 PREEMINENT。该层生物（PreeminentParasiteEntity）的 health 为 310~420、damage 为 33~110，是最强的寄生体层级，不可能缺少基础工具集。 矩阵修正：加入 ANCIENT。远古层（AncientParasiteEntity）是灾害级生物，拥有 ServerBossEvent 与 AncientPart[] 部位系统，不可能缺少基础工具集。 矩阵修正：加入 DERIVED。衍化体（Draconite 525/30/210、Kirin 410/30/155）是全图鉴数值最高的两只，不可能缺少基础工具集。 矩阵修正：加入 ABOMINATION。畸变体（AbominationEntity）是近战畸变个体，源码类注释为 Legacy Many Bodies and Giant Head close-combat abominations，不可能缺少基础工具集。

### 毒针爆发 / Venom Needle Burst

- **ID**: `venomneedleburst`
- **来源机制**: needler 的爆发结算
- **适用 Tier**: INBORN, PRIMITIVE, ADAPTED, PURE, DETERRENT, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, ANCIENT, DERIVED, ABOMINATION（需第 2 阶段）
- **属性 / 类别**: 虫 / 物理
- **威力 / 命中 / PP**: 25 / 95 / 15
...
- **视觉表现**: 密集针雨从口器射出。
- **不能学习者**: INBORN 只能学针刺。
- **矩阵修正记录**: 针刺是多段攻击形态：基础针刺属于全族，爆发形态从第二形态（裂噬兽）起才具备。 矩阵修正：加入 ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL。这五个 tier 都是被感染的宿主，本来就具备寄生体的基础工具（感染、接触、撕裂），不可能比 INBORN 更少。 矩阵修正：加入 ANCIENT。远古层（AncientParasiteEntity）是灾害级生物，拥有 ServerBossEvent 与 AncientPart[] 部位系统，不可能缺少基础工具集。 矩阵修正：加入 DERIVED。衍化体（Draconite 525/30/210、Kirin 410/30/155）是全图鉴数值最高的两只，不可能缺少基础工具集。 矩阵修正：加入 ABOMINATION。畸变体（AbominationEntity）是近战畸变个体，源码类注释为 Legacy Many Bodies and Giant Head close-combat abominations，不可能缺少基础工具集。
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, NEXUS, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, DERIVED, ABOMINATION
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 必中 / 10
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, DETERRENT, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 地面 / 变化
- **威力 / 命中 / PP**: - / 100 / 20
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 恶 / 物理
- **威力 / 命中 / PP**: 65 / 100 / 15
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, FERAL, PURE, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 必中 / 15
...
- **ID**: `berserkinfection`
- **来源机制**: rage 的传播形态
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, FERAL, PURE, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 100 / 10
...
- **矩阵修正记录**: 矩阵修正：加入 DERIVED。衍化体（Draconite / Kirin）的 health 为 410~525、damage 为 155~210，是全图鉴最强两只，其存在本身就是范围感染源并自带领域。
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, PURE, NEXUS, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 虫 / 变化
- **威力 / 命中 / PP**: - / 必中 / 5
...
- **矩阵修正记录**: 矩阵修正：加入 ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL。这五个 tier 都是被感染的宿主，本来就具备寄生体的基础工具（感染、接触、撕裂），不可能比 INBORN 更少。 矩阵修正：加入 DETERRENT。阻遏体（DeterrentParasiteEntity）的 movementSpeed 全部为 0.0，它们无法移动、无法追击，其全部作用依赖感染扩散与场地污染——这些正是基础工具集的内容。 矩阵修正：加入 PURE。掠夺者（marauder）本身就在 PURE 层，而它是全部 6 只 ASSIMARA 掠夺化体的来源，源码中类注释为 Legacy EntityEsor port，其身份就是投放/改造。排除它不合理。 矩阵修正：加入 NEXUS。Nexus 层的召唤柱（beckon_si 等）本身就是储存与释放寄生体的设施（源码字段 storedParasiteIds），召唤前必须指认目标。 矩阵修正：加入 ANCIENT。远古层（AncientParasiteEntity）是灾害级生物，拥有 ServerBossEvent 与 AncientPart[] 部位系统，不可能缺少基础工具集。 矩阵修正：加入 DERIVED。衍化体（Draconite 525/30/210、Kirin 410/30/155）是全图鉴数值最高的两只，不可能缺少基础工具集。 矩阵修正：加入 ABOMINATION。畸变体（AbominationEntity）是近战畸变个体，源码类注释为 Legacy Many Bodies and Giant Head close-combat abominations，不可能缺少基础工具集。
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, NEXUS, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, PREEMINENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 草 / 变化
- **威力 / 命中 / PP**: - / 必中 / 10
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, NEXUS, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 地面 / 变化
- **威力 / 命中 / PP**: - / 必中 / 10
...
- **矩阵修正记录**: 证据：WorkerEntity 的 BuildColonyGoal 就是产生感染地面的行为，工虫必须能学。 矩阵修正：加入 ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL。这五个 tier 都是被感染的宿主，本来就具备寄生体的基础工具（感染、接触、撕裂），不可能比 INBORN 更少。 矩阵修正：加入 DETERRENT。阻遏体（DeterrentParasiteEntity）的 movementSpeed 全部为 0.0，它们无法移动、无法追击，其全部作用依赖感染扩散与场地污染——这些正是基础工具集的内容。 矩阵修正：加入 ANCIENT。远古层（AncientParasiteEntity）是灾害级生物，拥有 ServerBossEvent 与 AncientPart[] 部位系统，不可能缺少基础工具集。 矩阵修正：加入 DERIVED。衍化体（Draconite 525/30/210、Kirin 410/30/155）是全图鉴数值最高的两只，不可能缺少基础工具集。 矩阵修正：加入 ABOMINATION。畸变体（AbominationEntity）是近战畸变个体，源码类注释为 Legacy Many Bodies and Giant Head close-combat abominations，不可能缺少基础工具集。
...
- **ID**: `waterambush`
- **来源机制**: SRP 的水域伏击行为
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, FERAL, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, PREEMINENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 水 / 物理
- **威力 / 命中 / PP**: 70 / 95 / 15
...
- **适用 Tier**: INBORN, ASSIMILATED, FERAL, CRUDE, PRIMITIVE, ADAPTED, PREEMINENT, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 毒 / 特殊
- **威力 / 命中 / PP**: 60 / 100 / 10
...
- **视觉表现**: 口部喷出黑色半固态物质。
- **不能学习者**: NEXUS / ANCIENT / DERIVED。
- **矩阵修正记录**: 载虫的 spawnLingeringCloud() 就是吐出体内生物质形成毒云，与呕吐同源，因此放开 INBORN。 矩阵修正：加入 ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL。这五个 tier 都是被感染的宿主，本来就具备寄生体的基础工具（感染、接触、撕裂），不可能比 INBORN 更少。 矩阵修正：加入 DETERRENT。阻遏体（DeterrentParasiteEntity）的 movementSpeed 全部为 0.0，它们无法移动、无法追击，其全部作用依赖感染扩散与场地污染——这些正是基础工具集的内容。 矩阵修正：加入 ANCIENT。远古层（AncientParasiteEntity）是灾害级生物，拥有 ServerBossEvent 与 AncientPart[] 部位系统，不可能缺少基础工具集。 矩阵修正：加入 DERIVED。衍化体（Draconite 525/30/210、Kirin 410/30/155）是全图鉴数值最高的两只，不可能缺少基础工具集。 矩阵修正：加入 ABOMINATION。畸变体（AbominationEntity）是近战畸变个体，源码类注释为 Legacy Many Bodies and Giant Head close-combat abominations，不可能缺少基础工具集。

### 感官强化 / Heightened Senses

- **ID**: `heightenedsenses`
- **来源机制**: mob effect `senses`
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, FERAL, DETERRENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 一般 / 变化
- **威力 / 命中 / PP**: - / 必中 / 15
...
- **适用 Tier**: INBORN, FERAL, CRUDE, PRIMITIVE, ADAPTED, PURE, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, PREEMINENT, NEXUS, ANCIENT, DERIVED, ABOMINATION
- **属性 / 类别**: 一般 / 变化
- **威力 / 命中 / PP**: - / 100 / 20
...
- **视觉表现**: 目标头顶出现暗红色标记。
- **不能学习者**: NEXUS / DETERRENT。
- **矩阵修正记录**: 矩阵修正：加入 ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL。这五个 tier 都是被感染的宿主，本来就具备寄生体的基础工具（感染、接触、撕裂），不可能比 INBORN 更少。 矩阵修正：加入 DETERRENT。阻遏体（DeterrentParasiteEntity）的 movementSpeed 全部为 0.0，它们无法移动、无法追击，其全部作用依赖感染扩散与场地污染——这些正是基础工具集的内容。 矩阵修正：加入 PREEMINENT。该层生物（PreeminentParasiteEntity）的 health 为 310~420、damage 为 33~110，是最强的寄生体层级，不可能缺少基础工具集。 矩阵修正：加入 NEXUS。Nexus 层的召唤柱（beckon_si 等）本身就是储存与释放寄生体的设施（源码字段 storedParasiteIds），召唤前必须指认目标。 矩阵修正：加入 ANCIENT。远古层（AncientParasiteEntity）是灾害级生物，拥有 ServerBossEvent 与 AncientPart[] 部位系统，不可能缺少基础工具集。 矩阵修正：加入 DERIVED。衍化体（Draconite 525/30/210、Kirin 410/30/155）是全图鉴数值最高的两只，不可能缺少基础工具集。 矩阵修正：加入 ABOMINATION。畸变体（AbominationEntity）是近战畸变个体，源码类注释为 Legacy Many Bodies and Giant Head close-combat abominations，不可能缺少基础工具集。
