...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, PREEMINENT, ANCIENT
- **属性 / 类别**: 虫 / 物理
- **威力 / 命中 / PP**: 40 / 100 / 25
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, PREEMINENT, ANCIENT
- **属性 / 类别**: 虫 / 物理
- **威力 / 命中 / PP**: 65 / 95 / 20
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, NEXUS, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ANCIENT
- **属性 / 类别**: 虫 / 变化
- **威力 / 命中 / PP**: - / 100 / 10
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, NEXUS, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ANCIENT
- **属性 / 类别**: 草 / 变化
- **威力 / 命中 / PP**: - / 90 / 15
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, NEXUS, PREEMINENT, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT
- **属性 / 类别**: 虫 / 变化
- **威力 / 命中 / PP**: - / 100 / 20
...
- **适用 Tier**: CRUDE, INBORN, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT
- **属性 / 类别**: 超能 / 变化
- **威力 / 命中 / PP**: - / 必中 / 20
...
- **适用 Tier**: CRUDE, INBORN, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ANCIENT
- **属性 / 类别**: 超能 / 变化
- **威力 / 命中 / PP**: - / 必中 / 15
...
- **适用 Tier**: CRUDE, INBORN, ADAPTED, PREEMINENT, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT
- **属性 / 类别**: 超能 / 变化
- **威力 / 命中 / PP**: - / 必中 / 10
...
- **ID**: `resistancelog`
- **来源机制**: Adaptation system
- **适用 Tier**: CRUDE, INBORN, ADAPTED, PURE, PREEMINENT, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT
- **属性 / 类别**: 钢 / 变化
- **威力 / 命中 / PP**: - / 必中 / 10
...
- **适用 Tier**: CRUDE, INBORN, ADAPTED, PREEMINENT, ANCIENT, DERIVED, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT
- **属性 / 类别**: 超能 / 变化
- **威力 / 命中 / PP**: - / 必中 / 5
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT
- **属性 / 类别**: 一般 / 物理
- **威力 / 命中 / PP**: 55 / 100 / 25
...
- **适用 Tier**: INBORN, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT（需第 2 阶段）
- **属性 / 类别**: 恶 / 物理
- **威力 / 命中 / PP**: 80 / 90 / 15
...
- **视觉表现**: 三道深可见骨的爪痕。
- **不能学习者**: INBORN 只能学裂创。
- **矩阵修正记录**: 深度撕裂比裂创更深，只有体型增大的第二形态以上才能造成。 矩阵修正：加入 ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL。这五个 tier 都是被感染的宿主，本来就具备寄生体的基础工具（感染、接触、撕裂），不可能比 INBORN 更少。 矩阵修正：加入 DETERRENT。阻遏体（DeterrentParasiteEntity）的 movementSpeed 全部为 0.0，它们无法移动、无法追击，其全部作用依赖感染扩散与场地污染——这些正是基础工具集的内容。

### 血流加速 / Blood Rush

- **ID**: `bloodrush`
- **来源机制**: bleed 与移动创伤的组合
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, FERAL, PURE, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, PREEMINENT, ANCIENT
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 100 / 15
...
- **ID**: `rendingpursuit`
- **来源机制**: SRP 追猎行为 + bleed
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, FERAL, PURE, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, PREEMINENT, ANCIENT
- **属性 / 类别**: 恶 / 物理
- **威力 / 命中 / PP**: 50 / 100 / 20
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ANCIENT
- **属性 / 类别**: 毒 / 物理
- **威力 / 命中 / PP**: 60 / 95 / 20
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, NEXUS, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, PREEMINENT, ANCIENT
- **属性 / 类别**: 毒 / 变化
- **威力 / 命中 / PP**: - / 100 / 15
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ANCIENT, DERIVED, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 100 / 20
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, DETERRENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, PREEMINENT, ANCIENT
- **属性 / 类别**: 虫 / 物理
- **威力 / 命中 / PP**: 35 / 100 / 30
- **效果**: 命中后附加 1 层【针刺】。
...
- **ID**: `venomneedleburst`
- **来源机制**: needler 的爆发结算
- **适用 Tier**: INBORN, PRIMITIVE, ADAPTED, PURE, DETERRENT, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, ANCIENT（需第 2 阶段）
- **属性 / 类别**: 虫 / 物理
- **威力 / 命中 / PP**: 25 / 95 / 15
...
- **视觉表现**: 密集针雨从口器射出。
- **不能学习者**: INBORN 只能学针刺。
- **矩阵修正记录**: 针刺是多段攻击形态：基础针刺属于全族，爆发形态从第二形态（裂噬兽）起才具备。 矩阵修正：加入 ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL。这五个 tier 都是被感染的宿主，本来就具备寄生体的基础工具（感染、接触、撕裂），不可能比 INBORN 更少。 矩阵修正：加入 ANCIENT。远古层（AncientParasiteEntity）是灾害级生物，拥有 ServerBossEvent 与 AncientPart[] 部位系统，不可能缺少基础工具集。
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, NEXUS, ANCIENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 必中 / 10
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, DETERRENT, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, ANCIENT
- **属性 / 类别**: 地面 / 变化
- **威力 / 命中 / PP**: - / 100 / 20
...
- **视觉表现**: 目标四肢被半透明丝线缠住。
- **不能学习者**: INBORN 不学。
- **矩阵修正记录**: 矩阵修正：加入 ASSIMILATED / WALKING_HEAD / ASSIMARA / HIJACKED / FERAL。这五个 tier 都是被感染的宿主，本来就具备寄生体的基础工具（感染、接触、撕裂），不可能比 INBORN 更少。 矩阵修正：加入 ANCIENT。远古层（AncientParasiteEntity）是灾害级生物，拥有 ServerBossEvent 与 AncientPart[] 部位系统，不可能缺少基础工具集。
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ANCIENT
- **属性 / 类别**: 恶 / 物理
- **威力 / 命中 / PP**: 65 / 100 / 15
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, FERAL, PURE, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, ANCIENT
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 必中 / 15
...
- **ID**: `berserkinfection`
- **来源机制**: rage 的传播形态
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, FERAL, PURE, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, ANCIENT
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 100 / 10
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, PURE, NEXUS, ANCIENT
- **属性 / 类别**: 虫 / 变化
- **威力 / 命中 / PP**: - / 必中 / 5
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, NEXUS, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, PREEMINENT, ANCIENT
- **属性 / 类别**: 草 / 变化
- **威力 / 命中 / PP**: - / 必中 / 10
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, NEXUS, PREEMINENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, FERAL, DETERRENT, ANCIENT
- **属性 / 类别**: 地面 / 变化
- **威力 / 命中 / PP**: - / 必中 / 10
...
- **ID**: `waterambush`
- **来源机制**: SRP 的水域伏击行为
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, FERAL, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, PREEMINENT, ANCIENT
- **属性 / 类别**: 水 / 物理
- **威力 / 命中 / PP**: 70 / 95 / 15
...
- **适用 Tier**: INBORN, ASSIMILATED, FERAL, CRUDE, PRIMITIVE, ADAPTED, PREEMINENT, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, ANCIENT
- **属性 / 类别**: 毒 / 特殊
- **威力 / 命中 / PP**: 60 / 100 / 10
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, FERAL, DETERRENT, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, ANCIENT
- **属性 / 类别**: 一般 / 变化
- **威力 / 命中 / PP**: - / 必中 / 15
...
- **适用 Tier**: INBORN, FERAL, CRUDE, PRIMITIVE, ADAPTED, PURE, ASSIMILATED, WALKING_HEAD, ASSIMARA, HIJACKED, DETERRENT, PREEMINENT, NEXUS, ANCIENT
- **属性 / 类别**: 一般 / 变化
- **威力 / 命中 / PP**: - / 100 / 20
