...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE
- **属性 / 类别**: 虫 / 物理
- **威力 / 命中 / PP**: 40 / 100 / 25
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED
- **属性 / 类别**: 虫 / 物理
- **威力 / 命中 / PP**: 65 / 95 / 20
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, NEXUS
- **属性 / 类别**: 虫 / 变化
- **威力 / 命中 / PP**: - / 100 / 10
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, NEXUS, PREEMINENT
- **属性 / 类别**: 草 / 变化
- **威力 / 命中 / PP**: - / 90 / 15
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ANCIENT
- **属性 / 类别**: 一般 / 物理
- **威力 / 命中 / PP**: 55 / 100 / 25
...
- **ID**: `bloodrush`
- **来源机制**: bleed 与移动创伤的组合
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, FERAL, PURE
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 100 / 15
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT
- **属性 / 类别**: 毒 / 物理
- **威力 / 命中 / PP**: 60 / 95 / 20
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, NEXUS
- **属性 / 类别**: 毒 / 变化
- **威力 / 命中 / PP**: - / 100 / 15
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, ANCIENT, DERIVED
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 100 / 20
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, DETERRENT
- **属性 / 类别**: 虫 / 物理
- **威力 / 命中 / PP**: 35 / 100 / 30
- **效果**: 命中后附加 1 层【针刺】。
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, NEXUS, ANCIENT
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 必中 / 10
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, DETERRENT, PREEMINENT
- **属性 / 类别**: 地面 / 变化
- **威力 / 命中 / PP**: - / 100 / 20
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT
- **属性 / 类别**: 恶 / 物理
- **威力 / 命中 / PP**: 65 / 100 / 15
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, FERAL, PURE, PREEMINENT
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 必中 / 15
...
- **ID**: `berserkinfection`
- **来源机制**: rage 的传播形态
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, FERAL, PURE, PREEMINENT
- **属性 / 类别**: 恶 / 变化
- **威力 / 命中 / PP**: - / 100 / 10
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PREEMINENT
- **属性 / 类别**: 虫 / 变化
- **威力 / 命中 / PP**: - / 必中 / 5
...
- **适用 Tier**: INBORN, CRUDE, PRIMITIVE, ADAPTED, PURE, NEXUS
- **属性 / 类别**: 草 / 变化
- **威力 / 命中 / PP**: - / 必中 / 10
...
- **适用 Tier**: FERAL, ADAPTED, PREEMINENT
- **属性 / 类别**: 超能 / 物理
- **威力 / 命中 / PP**: 75 / 100 / 10
...
- **ID**: `waterambush`
- **来源机制**: SRP 的水域伏击行为
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, FERAL
- **属性 / 类别**: 水 / 物理
- **威力 / 命中 / PP**: 70 / 95 / 15
...
- **ID**: `drowningpursuit`
- **来源机制**: SRP 水域追猎
- **适用 Tier**: PRIMITIVE, ADAPTED, FERAL
- **属性 / 类别**: 水 / 物理
- **威力 / 命中 / PP**: 60 / 100 / 10
...
- **适用 Tier**: CRUDE, PRIMITIVE, ADAPTED, PURE, PREEMINENT, FERAL, DETERRENT
- **属性 / 类别**: 一般 / 变化
- **威力 / 命中 / PP**: - / 必中 / 15
...
- **适用 Tier**: INBORN, FERAL, CRUDE, PRIMITIVE, ADAPTED, PURE
- **属性 / 类别**: 一般 / 变化
- **威力 / 命中 / PP**: - / 100 / 20
